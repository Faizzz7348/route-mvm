...
export default function CustomTableList() {
  ...
  return (
    <div className="animate-in fade-in duration-300">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 w-full border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 backdrop-blur supports-[backdrop-filter]:bg-background/60 shadow-sm">
      ...
      <main className="fixed inset-0 bg-gradient-to-br from-gray-50 to-white dark:from-gray-950 dark:to-black pt-[72px] pb-24 overflow-y-auto">
        ...
        <div className="bg-white dark:bg-gray-950 backdrop-blur-2xl border border-gray-200 dark:border-gray-800 shadow-xl rounded-xl overflow-hidden mb-8">
          {/* Header with Search */}
          ...
          <div className="overflow-x-auto overflow-y-auto max-h-[600px] scrollbar-thin scrollbar-thumb-gray-400 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent">
            <table className="w-full min-w-[600px] bg-transparent dark:bg-transparent">
              <thead className="bg-white dark:bg-gray-950 sticky top-0 z-10">
                ...
                {filteredRows.length === 0 ? (
                  ...
                  filteredRows.map((row, index) => {
                    ...
                    return (
                      <tr
                        key={row.id}
                        className={`custom-table-row border-b border-gray-200 dark:border-gray-900 hover:bg-gray-100 dark:hover:bg-gray-900 cursor-pointer ${
                  ...
                  <div className="custom-table-card flex items-center justify-between p-4 bg-transparent rounded-xl border border-gray-300 dark:border-gray-800/40 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        size="sm"
                        variant="outline"
                        className="bg-transparent border-transparent hover:bg-gray-100 dark:hover:bg-gray-900"
                      >
                        View
                      </Button>
                      <DropdownMenu>
